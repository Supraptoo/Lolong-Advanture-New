    ...
    if (empty($errors)) {
        try {
            $stmt = $pdo->prepare("INSERT INTO destinations 
                                (name, location, description, duration, price, difficulty, image_url, is_featured, created_at) 
                                VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())");
            $stmt->execute([$name, $location, $description, $duration, $price, $difficulty, $image_url, $is_featured]);
...
<head>
    ...
    <title>Tambah Destinasi - Lolong Adventure</title>
        ...
        <div id="content" class="main-content">
            ...
            <div class="container-fluid p-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2><i class="bi bi-plus-lg me-2"></i> Tambah Destinasi Baru</h2>
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" id="destinationForm">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="location" name="location"
                                        value="<?= isset($_SESSION['form_data']['location']) ? htmlspecialchars($_SESSION['form_data']['location']) : '' ?>"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="5" required><?= isset($_SESSION['form_data']['description']) ? htmlspecialchars($_SESSION['form_data']['description']) : '' ?></textarea>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="duration" name="duration"
                                        value="<?= isset($_SESSION['form_data']['duration']) ? htmlspecialchars($_SESSION['form_data']['duration']) : '' ?>"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="difficulty" name="difficulty" required>
                                        <option value="easy" <?= (isset($_SESSION['form_data']['difficulty']) && $_SESSION['form_data']['difficulty'] === 'easy') ? 'selected' : '' ?>>Mudah</option>
                                        <option value="medium" <?= (isset($_SESSION['form_data']['difficulty']) && $_SESSION['form_data']['difficulty'] === 'medium') ? 'selected' : '' ?>>Sedang</option>
                                        <option value="hard" <?= (isset($_SESSION['form_data']['difficulty']) && $_SESSION['form_data']['difficulty'] === 'hard') ? 'selected' : '' ?>>Sulit</option>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <div class="form-check form-switch mt-2">
                                        <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured"
                                            <?= isset($_SESSION['form_data']['is_featured']) ? 'checked' : '' ?>>
                            ...
                            <div class="mb-4">
                                <label for="image" class="form-label">Gambar Destinasi <span class="text-danger">*</span></label>
                                <input class="form-control" type="file" id="image" name="image" accept="image/jpeg, image/png, image/jpg, image/webp" required>
