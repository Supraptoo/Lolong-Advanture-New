        ...
        try {
            ...
            if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
                ...
                if (in_array(strtolower($file_extension), $allowed_extensions)) {
                    ...
                    if ($current_image && file_exists("../../assets/images/events/$current_image")) {
                        unlink("../../assets/images/events/$current_image");
                    }
            ...
            if ($stmt->execute([$title, $description, $event_date, $location, $max_participants, $price, $image_url, $is_active, $id])) {
                $_SESSION['success'] = 'Event berhasil diperbarui!';
                header('Location: events.php');
                exit();
            } else {
                throw new Exception('Gagal memperbarui event. Silakan coba lagi.');
            }
...
<head>
    ...
    <title>Edit Event - Lolong Adventure</title>
                    ...
                    <div class="col-12">
                        <div class="card form-container">
                            <div class="card-header bg-primary text-white">
                                <h5 class="mb-0"><i class="bi bi-calendar-plus me-2"></i> Edit Event</h5>
                            </div>
                            <div class="card-body">
                                <?php if ($error): ?>
                                ...
                                <form method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" class="form-control" id="max_participants" name="max_participants"
                                                value="<?php echo htmlspecialchars($event['max_participants']); ?>" min="1" required>
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php if (!empty($event['image_url'])): ?>
                                            <img src="../../assets/images/events/<?php echo htmlspecialchars($event['image_url']); ?>"
                                                class="current-image"
                                                alt="Current Event Image"
                                                onerror="this.onerror=null;this.src='../../assets/images/events/default.jpg';">
                                        <?php else: ?>
                                    ...
                                    <div class="mb-3">
                                        <label for="image" class="form-label">Ubah Gambar Event</label>
